...
mixin _$PlaybackProgress {
 ...
 String get contentId; Duration get position; Duration get duration; DateTime get updatedAt;
...
@override
int get hashCode => Object.hash(runtimeType,contentId,position,duration,updatedAt);

@override
String toString() {
  return 'PlaybackProgress(contentId: $contentId, position: $position, duration: $duration, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String contentId, Duration position, Duration duration, DateTime updatedAt
});
...
/// Create a copy of PlaybackProgress
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? contentId = null,Object? position = null,Object? duration = null,Object? updatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String contentId,  Duration position,  Duration duration,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PlaybackProgress() when $default != null:
return $default(_that.contentId,_that.position,_that.duration,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String contentId,  Duration position,  Duration duration,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _PlaybackProgress():
return $default(_that.contentId,_that.position,_that.duration,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String contentId,  Duration position,  Duration duration,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _PlaybackProgress() when $default != null:
return $default(_that.contentId,_that.position,_that.duration,_that.updatedAt);case _:
  return null;
...
class _PlaybackProgress extends PlaybackProgress {
  const _PlaybackProgress({required this.contentId, required this.position, required this.duration, required this.updatedAt}): super._();
...
/// Create a copy of PlaybackProgress
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? contentId = null,Object? position = null,Object? duration = null,Object? updatedAt = null,}) {
